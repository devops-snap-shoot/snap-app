...
if 'search_input' not in st.session_state:
    st.session_state.search_input = settings.text_query  # Initialize with text_query if it exists
...
with col1:
    ...
    if new_input:
        ...
        settings.text_query = new_input  # Keep text_query in sync with the user input
...
if settings.text_query and not output_print:
    if new_input:
        perform_search(new_input)
if message != "":
    st.warning(message)